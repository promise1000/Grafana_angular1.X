...
System.register(['lodash', 'jquery', 'jquery.flot', 'jquery.flot.pie'], function (_export, _context) {
  ...
  function link(scope, elem, attrs, ctrl) {
    ...
    function progressBar(ctrl) {
      ...
      var tagStyle = shape === 'triangle' ? 'height:0;width:0;border-width:' + tagWidth + 'px;border-top-color:' + ctrl.panel.sliderColor : 'height:' + tagWidth + 'px;width:' + tagWidth + 'px;background:' + ctrl.panel.sliderColor;
      // 拼bar容器标签
